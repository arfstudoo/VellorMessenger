  ...
  return (
    <div className="flex flex-col h-full bg-[#030303] relative z-50 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-8 pb-24">
        {/* Cinematic Banner - УЛУЧШЕННЫЙ */}
        <div className="relative rounded-[2.5rem] overflow-hidden border border-white/10 h-72 group shadow-2xl shrink-0">
            ...
            <MDiv 
                ...
                className="absolute -top-1/2 -right-1/4 w-[700px] h-[700px] bg-gradient-to-br from-fuchsia-600/20 via-purple-600/20 to-blue-600/20 blur-[120px] rounded-full mix-blend-screen"
            />

            <div className="absolute inset-0 flex flex-col justify-end p-10 z-10 bg-gradient-to-t from-black/80 via-black/20 to-transparent">
                <MDiv 
                ...
                <MH2 
                    ...
                    className="text-5xl md:text-6xl font-black uppercase tracking-wider leading-[0.85] mb-5 drop-shadow-2xl"
                >
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 via-purple-500 to-blue-500 animate-gradient">ORIGINS</span>
                </MH2>
            </div>
        </div>
